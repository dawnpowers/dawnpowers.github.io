...
function $c_sci_Vector$() {
  ...
  $n_sci_Vector$ = this;
  $p_sci_Vector$__liftedTree1$1__I(this);
...
$c_scm_ListBuffer.prototype.iterator__sc_Iterator = (function() {
  return new $c_scm_MutationTracker$CheckedIterator(($n(this.scm_ListBuffer__f_first), $m_sc_Iterator$().sc_Iterator$__f_scala$collection$Iterator$$_empty), new $c_sjsr_AnonFunction0((() => this.scm_ListBuffer__f_mutationCount)))
});
